#Si realizamos la misma simulación con un sistema ternario, obtenemos la siguiente 
#configuración:
import numpy as np
...
# Mathematical Model of the Three-Body Problem
...
r1 = np.array([-1, 0.0, 0.0])     # [m]
r2 = np.array([1, 0.0, 0.0])      # [m]
r3 = np.array([0.0, 2, 0.0])      # [m]
...
planet3_orbit, = ax.plot(r3_sol[:,0], r3_sol[:,1], r3_sol[:,2], color="gold")
 
# Plot final positions of the planets
planet1_final, = ax.plot(r1_sol[0:1,0], r1_sol[0:1,1], r1_sol[0:1,2], color="darkblue", marker="o", markersize=5, label="Star 1")
planet2_final, = ax.plot(r2_sol[0:1,0], r2_sol[0:1,1], r2_sol[0:1,2], color="tab:red", marker="o", markersize=5, label="Star 2")
planet3_final, = ax.plot(r3_sol[0:1,0], r3_sol[0:1,1], r3_sol[0:1,2], color="gold", marker="o", markersize=5, label="Star 3")
 
# Misc. plot details
ax.set_xlabel("x-coordinate", fontsize=14)
ax.set_ylabel("y-coordinate", fontsize=14)
ax.set_zlabel("z-coordinate", fontsize=7)
ax.set_title("Three body Trajectories", fontsize=14)
